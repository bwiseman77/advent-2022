...
def main():
    ...
    fs_size = get_size(fs, "/", count, 0)
    need_to_free = 30000000 - (70000000-fs_size)
    count = []
    fs_size = get_size(fs, "/", count, need_to_free)
    count.append(("/",fs_size))
    print(count)
